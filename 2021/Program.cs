...
var day05 = new Day05(Input.Year(2021).Day(5).ReadLines());
...
Console.WriteLine($"1: {day07.SolvePart1()}");
Console.WriteLine($"2: {day07.SolvePart2()}");
Console.WriteLine();


var day08 = new Day08(Input.Year(2021).Day(8).ReadLines());
